...
def get_args():
    parser = OptionParser()
    parser.add_option('-e', '--result', dest='result', default="Results_real_hurry", help='folder of results')
    ...
    parser.add_option('-i', '--input', dest='input', default="a", help='folder of input')
    parser.add_option('-g', '--gt', dest='gt', default="b", help='folder of ground truth')
