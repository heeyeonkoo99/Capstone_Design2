...
def get_args():
    ...
    parser.add_option('-i', '--input', dest='input', default='train_in_today', help='folder of input')
    parser.add_option('-g', '--ground truth', dest='gt', default='train_gt_today', help='folder of ground truth')
...
def setup_and_run_train(dir_input, dir_gt, dir_model, val_perc, batch_size, epochs, lr):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        path_csv = dir_model + "loss and others with noise" + ".csv"
